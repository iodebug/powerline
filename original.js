(function(s, x, k) {
    ...
    var pc = function() {
        ...
        qc = function() {
            ...
            a.keydown = function(d) {
                ...
                if (N && f) 13 == d.keyCode || 32 == d.keyCode ? clickPlay(s.localStorage.nick) : 27 == d.keyCode && (k("#statsPanel").hide(), k("#basePanel").show(), k("#nick").focus());
                    ...
                    70 == d.keyCode ? (x.fullscreenElement || x.mozFullScreenElement || x.webkitFullscreenElement || x.msFullscreenElement ? x.exitFullscreen ? x.exitFullscreen() :
        ...
        hc = function() {
            ...
            this.deleteNetwork = function(b, a) {
                oa ? (this.beingDeleted = !0, this.beginGrabX = this.x, this.beginGrabY = this.y, 0 < this.killedByID && this.playSounds && (lastDistVolume = Nb(this.x, this.y), D.playSound(Ec, Fc * lastDistVolume * R, 1.5, sa, null))) : delete y[this.id];
                return a
            };
                    ...
                    switch (d) {
                        ...
                        case 1:
                            var d = a.getUint8(b, !0),
                                ...
                                b = b + 1,
                                b = Qa(a, b),
                                h = b.nick; - 1 != h.indexOf("\ufdfd") && (h = "<Unnamed>");
                            b = b.offset;
                            g = d;
                            var u = null;
                            switch (g) {
